...
ob = np.array([
    #cadeira no corredor
    [2.0,0.5],[2.0,0.25],[2.5,0.7],[2.27,0.25],

    #mesas e cadeiras da esquerda
    [0.5,1.5],[0.75,1.5],[1.0,1.5],[1.25,1.5],[1.50,1.5],[0.5,3.0],[0.75,3.0],
    [1.0,3.0],[1.25,3.0],[1.50,3.0],[1.5,3.25],[1.5,3.5],[1.0,3.5],

    #mesas e cadeira da direita
    [4.5,1.5],[4.25,1.5],[4.0,1.5],[3.75,1.5],[3.50,1.5],[4.5,3.0],[4.25,3.0],
    [4.0,3.0],[3.75,3.0],[3.50,3.0],[3.5,3.25],[3.5,3.5],[4.0,3.5],

    #paredes
    [0.0,0.25],[0.0,0.5],[0.0,0.75],[0.0,1.0],[0.0,1.25],[0.0,1.5],[0.0,1.75],[0.0,2.0],[0.0,2.25],
    [0.0,2.5],[0.0,2.75],[0.0,3.0],[0.0,3.25],[0.0,3.5],[0.0,3.75],[0.0,4.0],[0.0,4.25],[0.0,4.5],
    [0.0,4.75],[0.0,5.0],[5.0,0.25],[5.0,0.5],[5.0,0.75],[5.0,1.0],[5.0,1.25],[5.0,1.5],[5.0,1.75],
    [5.0,2.0],[5.0,2.25],[5.0,2.5],[5.0,2.75],[5.0,3.0],[5.0,3.25],[5.0,3.5],[5.0,3.75],[5.0,4.0],
    [5.0,4.25],[5.0,4.5],[5.0,4.75],[5.0,5.0],[0.25,0.0],[0.5,0.0],[0.75,0.0],[1.0,0.0],[1.25,0.0],
    [1.5,0.0],[1.75,0.0],[2.0,0.0],[2.25,0.0],[2.5,0.0],[2.75,0.0],[3.0,0.0],[3.25,0.0],[3.5,0.0],
    [3.75,0.0],[4.0,0.0],[4.25,0.0],[4.5,0.0],[4.75,0.0],[5.0,0.0],[0.25,5.0],[0.5,5.0],[0.75,5.0],
    [1.0,5.0],[1.25,5.0],[1.5,5.0],[1.75,5.0],[2.0,5.0],[2.25,5.0],[2.5,5.0],[2.75,5.0],[3.0,5.0],
    [3.25,5.0],[3.5,5.0],[3.75,5.0],[4.0,5.0],[4.25,5.0],[4.5,5.0],[4.75,5.0],[5.0,5.0],
])
def loop():
    x = param['x']
